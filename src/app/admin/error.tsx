  ...
  return (
    <div className="ops-error-state" role="alert">
      <div>
        ...
        <h1 className="text-lg font-bold text-[var(--ops-text)]">Yönetim verileri alınamadı</h1>
        <p className="mt-2 text-sm leading-6 text-[var(--ops-muted)]">Bağlantıyı kontrol edip bu görünümü yeniden yükleyin.</p>
