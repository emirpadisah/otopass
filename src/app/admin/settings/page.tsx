...
export default async function AdminSettingsPage() {
  ...
  const securityItems = ["Private Supabase Storage ve imzalı upload", "Rol ve hesap aktifliği doğrulaması", "Atomik HMAC rate limit ve Turnstile", "365 + 30 günlük veri yaşam döngüsü"];
