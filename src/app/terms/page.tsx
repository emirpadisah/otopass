...
export const metadata: Metadata = { title: "Kullanım koşulları | otoköprü" };
  ...
  return (
    <main className="legal-page">
      ...
      <article className="panel legal-document">
        ...
        <h2>Hizmetin kapsamı</h2><p>otoköprü, araç sahipleri ile galeriler arasındaki başvuru, ön değerlendirme ve teklif sürecini dijital ortamda yürütmek için teknik altyapı sağlar. Form gönderimi satış sözleşmesi veya kesin fiyat taahhüdü oluşturmaz.</p>
