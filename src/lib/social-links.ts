...
export const SOCIAL_PLATFORM_OPTIONS = [
  ...
  { value: "linkedin", label: "LinkedIn", placeholder: "https://linkedin.com/company/galeri" },
  ...
  { value: "pinterest", label: "Pinterest", placeholder: "https://pinterest.com/galeri" },
  { value: "twitch", label: "Twitch", placeholder: "https://twitch.tv/galeri" },
  { value: "discord", label: "Discord", placeholder: "https://discord.gg/davet" },
